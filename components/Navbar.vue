...
useHead({
  ...
  script: [ { innerHTML: 'console.log(\'Hello world\')' } ]
      ...
      @font-face {
          font-family: 'Emotiq';
          src: url('@/assets/fonts/emotiq.otf') format('opentype');
          font-weight: normal;
          font-style: normal;
        }
  ...
  <section>
    <div class="navbar bg-base-100 shadow-sm">
      ...
      <div class="navbar-center">
        <a class="btn btn-ghost text-xl">My Nuxt App</a>
      </div>
      <div class="navbar-end flex items-center gap-4">
        <label class="flex cursor-pointer gap-2 items-center">
          <span class="label-text">Dark</span>
          <input type="checkbox" class="toggle" :checked="theme === 'cyberpunk'" @change="toggleTheme" />
